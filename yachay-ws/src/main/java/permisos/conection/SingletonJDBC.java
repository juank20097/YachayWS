...
public class SingletonJDBC {
	...
	private static String URL = "jdbc:postgresql://10.1.0.158:5432/app_permisos";
	private static String USER = "adm_appermisos";
	private static String PASS = "N)mE14_fP!+]";
//	private static String URL = "jdbc:postgresql://localhost:5432/app_permisos";
